...
let empUrl = 'http://localhost:8082/ProjectOne/reimbursement';
let empUrlC = 'http://localhost:8082/ProjectOne/completedreimbursement';
...
function populateUser() {
	...
	fetch("http://localhost:8082/ProjectOne/session").then(function(response) {
